...
$l_error_addforum='There was an error adding the forum: Forum name can not be empty';
...
$l_topicsWillBeDisplayed='Since this is only one forum in a system, topics will already be displayed on the first page, according to your setup.';
...
$l_forumnotexists='<center>Forum doesn`t exist</center>';
$l_topicnotexists='<center>Topic doesn`t exist. It was deleted by administrator or even NEVER existed</center>';
$l_topiccannotempty='<center>Topic title cannot be empty!</center>';
$l_back='<center>Return back</center>';
$l_returntoforums='<center>Return to the forums list</center>';

$l_forbidden='<center>You are not allowed to perform this action</center>';
...
$l_topic_closed='<center>This topic is closed. You can`t post a reply.</center>';
...
$l_itseemserror='<center>Sorry, it seems there was an error during the operation!</center>';

$l_submit='Submit';
$l_yes='Yes';
$l_no='No';

$l_topicLocked='<center>Topic was locked</center>';
$l_topicUnLocked='<center>Topic was unlocked</center>';

$l_topicsDeleted='Topics deleted: ';
$l_postsDeleted='Posts deleted: ';

$l_emptyPost='<center>Your post contains an empty field!</center>';
...
$l_noTopicsInForum='<center>This forum has no topics. You can post first!</center>';
...
$l_postNotExist='<center>Post doesn`t exist!</center>';

$l_areYouSureDeletePost='<center>Are you sure you want to delete this post?</center>';

$l_postID='Post ID';
$l_poster='Poster';

$l_postDeleted='<center>Post successfuly deleted</center>';
...
$l_postEdited='</center>Post was successfully edited</center>';
$l_editPost='Edit post';

$l_topicTitleUpdated='<center>Topic title was updated.</center>';

$l_onlyAdminCanEdit='<center>This post was edited or censored by admin previously. You can not edit it anymore!</center>';
$l_topicTextUpdated='<center>Post text was updated.</center>';
...
$l_antiSpam='<center>Anti-spam protection: you can make only one post in '.$postRange.' seconds!</center>';
...
$l_accessDenied='<center>Access denied</center>';
