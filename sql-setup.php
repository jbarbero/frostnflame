...
if(mysqli_num_rows(db_safe_query("SELECT * FROM $playerdb WHERE num=1;")) == 0) {
    db_safe_query("INSERT INTO `$prefix"."_players` (username, password, passchanged, rsalt, name, email, IP, signedup, disabled, online, idle, empire, num, rank, turns, turns_last, hour_last, troops, troops_res, production, turnbank, turnbank_last, pvmarket, pvmarket_last, pmkt_food, bmper, bmper_last, msgtime, newstime, profile, igname, aim, msn, stocks, folders) VALUES ('admin', '5f4dcc3b5aa765d61d8327deb882cf99', '1', '23768', 'Administrative Officer', 'jbarbero+faf@gmail.com', '127.0.0.1', '1204417010', '2', '1', '1204417105', 'Administrator', '1', '1', '150', '1204416600', '1204416000', '0|0|0|0', '', '25|25|25|25', '100', '1204416000', '8333|4167|2083|14', '0', '100000', '0|0|0|0', '0', '1204417010', '1204417010', '', 'Administrator', '', '', '1000|1000|1000|1000|1000|1000|1000|1000', 'Inbox|Sent') ;");
}
echo mysqli_error($GLOBALS["db_link"]);
