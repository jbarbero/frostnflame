...
if(isset($_POST['submit'])) {
    ...
    $sql = mysql_query("INSERT INTO ".$prefix."_motd SET subject='$subject', content='$content', author='$author', date=now()") or die("Error: ".mysql_error());	
    $sql = mysql_query("UPDATE ".$prefix."_players SET motd='1' WHERE 1=1") or die("Error: ".mysql_error());
